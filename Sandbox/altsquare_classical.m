...
RecogniseAltSquareWithTensorDecompositionSp := function( G : 
    ...
    eiglim1 := case< dim | 6: 8, default: (2/9)*dim^2+1 >; 
    ...
    // in the case of Sp there is a one-dimensional component
   ...
   /* Construct the image of CD in the tensor product component. It must be 
    ...
    /* The basis of the original space can be built using the bases
       constructed. The problem is that there may be a scalar involved.
       We recover the scalars by "sampling" the bilinear form preserved
       by G. */
