...
/*        goodtypes := case< type | 
        ...
        */
        ...
        //if  not types in goodtypes then error( "wrong types" ); end if;
   ...
   if typeh eq "Omega-" and typek eq "Omega-" and dK eq 6 then 
        posK1 := funcpos_symsquare( dim, (dH div 2),(dH div 2)+1 : type := type );
        posK2 := funcpos_symsquare( dim, dim-(dH div 2),dim-(dH div 2)+1 : type := type );
   end if;
